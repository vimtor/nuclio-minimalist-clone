...
import ShareList from '../../modal/share-users';
    ...
    return (
        <div>
            ...
            <header className={styles.header}>
                        ...
                        />
                        <div>
                            <svg onClick={refreshList} fill="gray" style={{cursor: 'pointer'}} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={openModal} style={{cursor: 'pointer'}} fill="gray" width="24" height="24" viewBox="0 0 24 24">
                                <path
                                    d="M4.5 8.552c0 1.995 1.505 3.5 3.5 3.5s3.5-1.505 3.5-3.5-1.505-3.5-3.5-3.5S4.5 6.557 4.5 8.552zM19 8L17 8 17 11 14 11 14 13 17 13 17 16 19 16 19 13 22 13 22 11 19 11zM4 19h8 1 1v-1c0-2.757-2.243-5-5-5H7c-2.757 0-5 2.243-5 5v1h1H4z"/>
                            </svg>
                            <Modal
                                isOpen={modalIsOpen}
